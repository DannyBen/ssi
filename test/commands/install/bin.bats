...
@test "install bin is a no-op in dry run mode" {
  ...
  [ "$status" -eq 0 ]
  [ "$output" = $'• warn  → Dry-run enabled\n• info  → Installing executable: tool\n• info  → Executable installed: '"$SSI_USER_BIN_ROOT"'/tool' ]
