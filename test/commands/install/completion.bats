...
@test "install completion is a no-op in dry run mode" {
  ...
  [ "$status" -eq 0 ]
  [ "$output" = $'• warn  → Dry-run enabled\n• info  → Installing completion: tool\n• info  → Completion installed: '"$SSI_USER_BASH_COMPLETION_ROOT"'/tool' ]
